...
//	In the Movie play() method body, call the interface Play’s play() method 
	...
	public static void main(String[] args) {
		...
		movie.add(new Movie("Divine Secrets of the Ya-Ya Sisterhood", 116, divineSecretsOfTheYaYaSisterhoodSceneList,
				new VHS()));
	...
	public static void welcomeToBlockBuster() {
		...
		System.out.println("*Technically true, all the other BlockBusters are closed.");
		System.out.println("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
		do {
			...
			if (userSelection <= (movie.size()) && (userSelection != 0)) {
				...
				if (response.equalsIgnoreCase("y")) {
					...
					System.out.println("Thanks for visiting Sam's BlockBuster!\nBe kind, REWIND!");
					yesOrNo = false;
				}
