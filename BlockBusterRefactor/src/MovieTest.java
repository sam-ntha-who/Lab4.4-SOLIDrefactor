...
class MovieTest {
	...
	void DVDTitleRunTimeTest() {
		...
		DVD tester = new DVD("Avatar", 160, AvatarSceneList);
	...
	void VHSTitleTest() {
		...
		VHS tester = new VHS("Divine Secrets of the Ya-Ya Sisterhood", 116, divineSecretsOfTheYaYaSisterhoodSceneList);
	...
	void VHSPlayTest() {
		...
		tester.play(divineSecretsOfTheYaYaSisterhoodSceneList);
